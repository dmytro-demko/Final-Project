...
driver.find_element(By.XPATH,"//body/div[@id='fn_content']/div[1]/div[2]/div[1]/div[1]/div[1]/form[1]/div[2]/div[1]/input[1]").send_keys(333)

driver.find_element(By.NAME, "last_name").send_keys(222)

driver.find_element(By.NAME, "email").send_keys("333@gmail.co")

def generate_phone_number():
    first_three_digits = random.choice(['050', '067'])
    last_seven_digits = ''.join([str(0) for _ in range(7)])
